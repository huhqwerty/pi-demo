...
/*
 * This version requires the platformAPICLient (see platformAPIClient.ts) to be passed as a parameter on the request body for all endpoints
 */

export default function mountPaymentsEndpoints(router: Router) {
  // handle the incomplete payment
  router.post('/incomplete', async (req, res) => {
    const platformAPIClient = req.body.platformAPIClient;
